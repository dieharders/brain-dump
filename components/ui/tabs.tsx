          ...
          return (
            ...
            >
              <label className="w-full" title={i.title}>
                ...
                />
                <div className={cn("text-md border-b-2 border-b-neutral-300 p-2 text-primary/50 hover:border-b-neutral-400 hover:text-primary peer-checked:border-b-primary peer-checked:text-primary dark:border-b-accent dark:hover:border-b-neutral-600 dark:peer-checked:border-b-muted-foreground lg:text-2xl", className)} >
