...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay className="fixed inset-0 flex items-start justify-center overflow-y-auto overflow-x-hidden sm:py-16">
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      'flex flex-col-reverse space-y-4 space-y-reverse sm:flex-row sm:justify-end sm:space-x-2 sm:space-y-0',
      className
    )}
    {...props}
  />
