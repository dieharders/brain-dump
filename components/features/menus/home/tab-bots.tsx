...
export const BotCreationMenu = (props: I_Props) => {
  ...
  const toolsMenu = useMemo(() => <ToolsTab fetchListAction={fetchTools} setSelected={setSelectedTools} />, [fetchTools, setSelectedTools])
  ...
  const onSaveClick = useCallback(
    ...
    [onSubmit, selectedTools, setDialogOpen, stateAttention, stateModel, statePerformance, statePrompt, stateResponse, stateSystem],
  )
